...
export const exercises: Exercise[] = [
  {
    ...
    image: '🏋️',
    video: 'local://supino-reto',
    instructions: [
      'Deite-se no banco com os pés firmes no chão.',
      'Segure a barra pouco além da largura dos ombros.',
      'Desça a barra de forma controlada até o meio do peito.',
      'Empurre a barra até estender os braços sem travar os cotovelos.',
    ],
  },
  {
  ...
  },
  {
    ...
    image: '🏋️',
    video: 'local://desenvolvimento',
    instructions: [
      'Sente-se com as costas apoiadas e halteres na altura dos ombros.',
      'Mantenha os punhos alinhados aos cotovelos.',
      'Empurre os halteres para cima em um arco leve.',
  ...
  },
  {
    ...
    difficulty: 'Iniciante',
    image: '💪',
    video: 'local://rosca-direta',
    instructions: [
      'Fique em pé com a barra à frente das coxas.',
  ...
  },
  {
    ...
    difficulty: 'Iniciante',
    image: '⚡',
    video: 'local://triceps-corda',
    instructions: [
      'Ajuste a polia na posição alta e segure a corda.',
      'Mantenha os cotovelos fixos junto ao corpo.',
      'Estenda os braços até separar levemente as pontas da corda.',
      'Retorne de forma controlada até 90 graus.',
    ],
  },
  {
    ...
    difficulty: 'Avançado',
    image: '🏋️',
    video: 'local://levantamento-terra',
    instructions: [
      'Aproxime a barra das canelas e afaste os pés na largura do quadril.',
      'Segure a barra mantendo a coluna neutra.',
      'Estenda joelhos e quadril ao mesmo tempo.',
      'Desça a barra junto ao corpo com controle.',
    ],
  },
  {
    id: 'elevacao-lateral',
    ...
    instructions: [
      ...
      'Desça devagar, mantendo o controle do movimento.',
    ],
  },
];

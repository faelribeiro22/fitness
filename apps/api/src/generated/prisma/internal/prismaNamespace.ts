...
> = {
  ...
  meta: {
    modelProps: 'exercise' | 'workout' | 'workoutDay' | 'workoutExercise';
    ...
    Workout: {
      ...
      operations: {
        ...
        count: {
          ...
          result:
            | runtime.Types.Utils.Optional<Prisma.WorkoutCountAggregateOutputType>
            | number;
        };
      };
    };
    WorkoutDay: {
      ...
      operations: {
        ...
        count: {
          ...
          result:
            | runtime.Types.Utils.Optional<Prisma.WorkoutDayCountAggregateOutputType>
            | number;
        };
      };
    };
    WorkoutExercise: {
      ...
      operations: {
        ...
        count: {
          ...
          result:
            | runtime.Types.Utils.Optional<Prisma.WorkoutExerciseCountAggregateOutputType>
            | number;
        };
      };
    };
...
export type WorkoutDayScalarFieldEnum =
  (typeof WorkoutDayScalarFieldEnum)[keyof typeof WorkoutDayScalarFieldEnum];
